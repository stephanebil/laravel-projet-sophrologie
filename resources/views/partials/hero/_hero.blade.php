    ...
    <div class=' flex flex-col items-center justify-center'>
        ...
        <div class="absolute top-0 z-10 mt-[45%] md:mt-[35%] lg:mt-[20%]">    
            <div class=" text-center">
                <h1 class='text-sm md:text-2xl bg-[#C3994D] bg-opacity-60 lg:text-4xl py-2 px-2 md:py-8 md:px-8 rounded-xl font-black text-[#021a24]'>Bienvenue sur Valérie Delcourt Sophrologie</h1>
            </div>    
