<x-layouts.main-layout title="Bienvenue sur le Dashboard" >
    <section class="py-32 md:px-20 px-6">
        <h1 class="text-center font-bold text-bluefirst text-lg md:my-16 sm:text-xl md:text-2xl lg:text-4xl ">Bienvenue sur votre tableau de bord!</h1>
