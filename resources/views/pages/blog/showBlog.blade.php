<x-layouts.main-layout title="Show Blog" >
    <section class="px-4 md:px-20 py-32 ">
            ...
            <img src="{{ asset('storage/' . $blog->url_img) }}" alt="" class="rounded-lg w-[320px] md:ml-[15%] md:w-[70%]">
            <div class="pt-5">
            ...
            @auth
                <div class="py-8 flex space-x-5 gap-6 justify-center">
                    <a href="{{ route('blogs.edit', $blog->id) }}" class=" bg-bluehover text-goldhover duration-300 hover:bg-green-600 hover:text-white p-2 rounded-lg">Modifier</a>
