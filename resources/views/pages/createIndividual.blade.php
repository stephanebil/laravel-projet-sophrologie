...
<x-layouts.main-layout title="RDV individuel" >
 
     <div class="px-6 md:px-20 py-32">
       <h1 class="py-20 font-bold text-xl text-center md:text-4xl lg:text-6xl text-bluefirst ">Prendre un Rendez-vous individuel</h1>
       <form action="{{ route('listindividuals.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="">
