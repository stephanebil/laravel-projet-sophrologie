<x-layouts.main-layout title="Qui suis-je" >
    <section class="px-6 md:px-20 pt-20 md:pt-32 md:pb-20 pb-6">
        ...
        <p class="text-center text-bluefirst py-8 sm:px-10 md:px-20 lg:px-60 xl:px-72 ] ">Se présenter en quelques mots est un véritable exercice. Je suis Valérie, souriante telle un rayon de soleil, bienveillante, comme une main tendue entre vous et vous-même. Et pour le reste, venez me rencontrer, vous verrez par vous-même.</p> 
    </section>
    ...
    <section class="bg-graybg px-20">   
        <div class="md:flex md:space-x-16 text-center py-16 md:py-20 justify-center ">
            ...
            <div class="py-4">
                <x-items.buttonsophro  title="Prendre RDV" href="{{ route('rdv') }}" />
            </div>
        </div>
    </section>
